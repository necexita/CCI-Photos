...
$.fn.flickrGallery = function(options) {
  ...
  var defaults = {
		...
		useLightBox: 'false'				// [string], 'true' or 'false. Uses jQuery Lightbox plugin for Small .
  };
  ...
  return this.each(function() {
	...
	// Finally, if useFlickr is true, download . and create UL structure before creating Gallery. Else, just create Gallery.
	if ( options.useFlickr == 'true' ) {
		obj.flickr({     
			api_key: options.flickrAPIKey,     
			type: 'photoset',
